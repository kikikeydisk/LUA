...
local SCRIPT_FILE_ADDR = "https://raw.githubusercontent.com/kikikeydisk/LUA/main/zuoci.lua";
local VERSION_FILE_ADDR = "https://raw.githubusercontent.com/kikikeydisk/LUA/main/version.txt";
